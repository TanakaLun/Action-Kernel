...
感谢以下项目提供的思路与 Action 配置参考：

### OnePlus 内核构建参考
* [Liyu717/Action_Build_OnePlusACE2_Kernel](https://github.com/Liyu717/Action_Build_OnePlusACE2_Kernel)
* [Xiaomichael/OnePlus-Actions](https://github.com/Xiaomichael/OnePlus-Actions)
* [CHIZI-0618/OnePlus13T_Kernel_Build](https://github.com/CHIZI-0618/OnePlus13T_Kernel_Build)
...
* 本内核仅供测试使用。
* 刷机有风险，操作需谨慎。对于由使用本项目构建的镜像导致的任何设备损坏，本项目概不负责。
